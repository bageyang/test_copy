...
public class MachineSequenceNumberConfig implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            if (lock.tryLock()) {
                Set<String> snObjSet = redisTemplate.keys(redisKey+"*");
            ...
            if(Objects.isNull(machineNumber)){
                ...
                redisTemplate.opsForValue().set(redisKey+machineNumber,machineSnDto,MACHINE_SEQUENCE_EXPRESS_TIME,TimeUnit.SECONDS);
