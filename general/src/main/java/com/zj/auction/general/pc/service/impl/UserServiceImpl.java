...
//				config.setSubUserNum(count.intValue());
//			});
//		}
...
//        Area provinceArea = areaService.selectOne(wrapper);
...
//        wrapper.eq(Area::getDeleteFlag,0);
//        Area cityArea = areaService.selectOne(wrapper2);
...
//        wrapper.eq(Area::getDeleteFlag,0);
//        Area countyArea = areaService.selectOne(wrapper3);
...
//        userConfig.setSubUserNum(0);
//        userConfig.setSubUserNumAll(0);
...
//	//查询用户统计
//	@Override
//	public HashMap<String, Object> getStatistics(User userCfg) {
//		if(super.baseCheck(userCfg.getUserId(), Objects::isNull)) {
//			throw new RuntimeException("未获取到会员ID");
//		}
//		Function<User, HashMap<String, Object>> deal = param->{
//			HashMap<String, Object> map = new HashMap<>();
//			String userIdStr = ","+param.getUserId()+",";
//
//			List<Map<String,Object>> list = userMapper.getStatistics(userCfg.getUserId(),userIdStr);
//			//总人数
...
//		List<Map<String, Object>> list = areaService.selectMaps(areaLambdaQueryWrapper);
//		if(!list.isEmpty()) {
...
//			//添加余额
//			Wallet crWallet =
//			Wallet wallet = Wallet.builder().userId(user.getUserId()).fundType(moneyType).remark(memo).transactionType(1)
//			Wallet saveMoney = saveMoney(user.getUserId(), 1, 14, integral, 1, 1, 1, 0, memo, 0, pcUser.getUserId(), moneyType, memo, transactionId, null, remark);
