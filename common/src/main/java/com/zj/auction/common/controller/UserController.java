...
//import com.duoqio.boot.framework.annotation.SystemLog;
//import com.duoqio.boot.framework.shiro.SecurityUtils;
//import com.duoqio.common.content.RedisConstant;
//import com.duoqio.common.util.RedisUtil;
//import com.duoqio.common.vo.GeneralResult;
//import com.duoqio.common.vo.PageAction;
//import com.duoqio.entity.custom.SystemConfig;
...
//		List<SysPermisTbl> listResult = pcUserServer.findByMenuId(user.getUserId());
...
//	public GeneralResult createManager(UserInfoTbl userCfg) {
...
//	public GeneralResult findManagerByUserId(UserInfoTbl userCfg) {
//		GeneralResult result = new GeneralResult();
...
//	public GeneralResult updateManager(UserInfoTbl userCfg) {
...
//	public GeneralResult deleteUser(UserInfoTbl userCfg) {
...
//	public GeneralResult updateManagerStatus(UserInfoTbl userCfg) {
...
//		Page<UserInfoTbl> page = pcUserServer.getUserPage(pageAction, userType, null);
...
//		GeneralResult result = new GeneralResult();
//		UserInfoTbl userCfg = pcUserServer.getUserByUserId(userId);
...
//		GeneralResult result = new GeneralResult();
//		UserInfoTbl userCfg = new UserInfoTbl();
//		userCfg.setMemo1(userIds);
...
//	public GeneralResult getStatistics(UserInfoTbl userCfg) {
//		GeneralResult result = new GeneralResult();
...
//	public GeneralResult updateCfg(SystemCfgTbl systemCfg)  {
