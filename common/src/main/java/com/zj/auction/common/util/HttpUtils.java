...
/**
 * @Title HttpUtils
 * @Package com.duoqio.framework.util
...
public class HttpUtils {
     ...
     * @throws Exception
     */
    public static HttpResponse doPostJson(String host, String path, String method,
                                      Map<String, String> headers,
                                      Map<String, String> querys,
                                      Map<String, String> bodys)
            throws Exception {
        ...
        if (bodys != null) {
            JSONObject jsonObject = JSONObject.parseObject(JSON.toJSONString(bodys));
