...
CREATE TABLE `zj_auction`  (
  ...
  `auction_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '拍品名称',
...
CREATE TABLE `zj_auction_stock_relation`  (
  ...
  `stock_number` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `zj_goods`  (
  ...
  `post_id` int(0) NULL DEFAULT NULL COMMENT '邮费模板id',
  ...
  `acquire_integral` int(0) NULL DEFAULT 0 COMMENT '可返积分',
  `rebate_transaction_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '模板的id,这个值>0表示购买这个会向上级返利',
  `hot_flag` int(0) NULL DEFAULT 0 COMMENT '是否在热销展示 1为展示',
  `discount_flag` int(0) NULL DEFAULT 0 COMMENT '是否在折扣区展示 1为展示',
  `new_flag` int(0) NULL DEFAULT 0 COMMENT '是否新品展示 1为展示',
  `goods_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品名称',
  `img_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '封面图',
  `video_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '' COMMENT '视频地址',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商品详情',
  `type_id` int(0) NULL DEFAULT NULL COMMENT '类型id  默认0 普通商品  1 飞鱼自营 2 茅台专区',
  `status` int(0) NULL DEFAULT 0 COMMENT '状态,0：正常,1：下架',
  `transaction_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '事务id',
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '最近更新时间',
  `add_user_id` int(0) NULL DEFAULT NULL COMMENT '添加人id',
  `weight` double NULL DEFAULT NULL COMMENT '每件重量',
  `volume` double NULL DEFAULT NULL COMMENT '每件体积',
  `rebate_ratio` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '返利比例',
  `service_tel` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '客服电话',
  ...
  `frozen_explain` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '下架理由',
  `ship_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '发货地址',
  `buckle_point_ratio` decimal(19, 3) NOT NULL DEFAULT 0.010 COMMENT '平台返佣',
  `specification` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '产品规格',
  `tag_id` bigint(0) NULL DEFAULT -1 COMMENT '标签 0 全国 其他金刚区',
  `auction_id` bigint(0) NULL DEFAULT -1 COMMENT '竞拍区编号  上午 下午 晚上',
  `auction_status` int(0) NULL DEFAULT NULL,
  `hand_num` int(0) NULL DEFAULT 61 COMMENT '交割手数',
  `delivery_money` decimal(20, 2) NULL DEFAULT NULL COMMENT '交割金额',
  `sub_type` tinyint(0) NULL DEFAULT 0 COMMENT '产品二级分类',
  `cash_price` decimal(20, 2) NULL DEFAULT 0.00 COMMENT '新价/现金部分',
  `is_deleted` tinyint(0) NULL DEFAULT 0 COMMENT '删除状态，0未删除，1已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16797 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品表' ROW_FORMAT = Compact;
...
CREATE TABLE `zj_pay_log`  (
  ...
  `req_param` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `req_status` tinyint(0) NULL DEFAULT NULL,
  `res_status` tinyint(0) NULL DEFAULT NULL,
  `call_back_param` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `call_back_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `err_info` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `zj_stock`  (
  ...
  `stock_number` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '库存编号',
...
CREATE TABLE `zj_user_bill`  (
  ...
  `transtion_sn` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '流水号',
