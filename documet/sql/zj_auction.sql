...
(
    ...
    `auction_name`    varchar(32) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '拍品名称',
...
(
    ...
    `rebate_transaction_id` varchar(255) CHARACTER SET utf8 NULL DEFAULT NULL COMMENT '模板的id,这个值>0表示购买这个会向上级返利',
    ...
    `goods_name`            varchar(255) CHARACTER SET utf8 NULL DEFAULT NULL COMMENT '商品名称',
    `img_url`               varchar(255) CHARACTER SET utf8 NULL DEFAULT NULL COMMENT '封面图',
    `video_url`             varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT '' COMMENT '视频地址',
    `content`               text CHARACTER SET utf8 NULL COMMENT '商品详情',
    `type_id`               int(0) NULL DEFAULT NULL COMMENT '类型id  默认0 普通商品  1 飞鱼自营 2 茅台专区',
    `status`                int(0) NULL DEFAULT 0 COMMENT '状态,0：正常,1：下架',
    `remarks`               varchar(255) CHARACTER SET utf8 NULL DEFAULT NULL COMMENT '备注',
    `create_time`           datetime(0) NULL DEFAULT CURRENT_TIMESTAMP (0) COMMENT '添加时间',
    `update_time`           datetime(0) NULL DEFAULT CURRENT_TIMESTAMP (0) ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '最近更新时间',
    ...
    `frozen_explain`        varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '下架理由',
    `ship_address`          varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '发货地址',
    `buckle_point_ratio`    decimal(19, 3) NOT NULL DEFAULT 0.010 COMMENT '平台返佣',
    `specification`         varchar(255) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '产品规格',
    `tag_id`                bigint(0) NULL DEFAULT -1 COMMENT '标签 0 全国 其他金刚区',
    `auction_area_id`       bigint(0) NULL DEFAULT -1 COMMENT '竞拍区编号  上午 下午 晚上',
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8  COMMENT = '商品表' ROW_FORMAT = Compact;
...
(
    ...
    `is_deleted`  tinyint(0) NULL DEFAULT 0,
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8  COMMENT = '商品分类表' ROW_FORMAT = Dynamic;
...
(
    ...
    `order_sn`       bigint(0) NOT NULL COMMENT '订单编号',
    `goods_id`       bigint(0) NOT NULL COMMENT '商品id',
    `auction_id`     bigint(0) NULL DEFAULT NULL COMMENT '拍品id',
    `stock_id`       bigint(0) NOT NULL COMMENT '库存id',
    `stock_number`   bigint(0) NOT NULL COMMENT '库存号',
    `seller_user_id` bigint(0) NULL DEFAULT NULL COMMENT '卖家用户id',
    `user_id`        bigint(0) NULL DEFAULT NULL COMMENT '用户帐号',
    `total_amount`   decimal(10, 2) NULL DEFAULT NULL COMMENT '订单总金额',
    `pay_amount`     decimal(10, 2) NULL DEFAULT NULL COMMENT '应付金额（实际支付金额）',
    `order_fee`      decimal(10, 2) UNSIGNED NULL DEFAULT 0.00 COMMENT '手续费',
    `integral_fee`   decimal(10, 2) NULL DEFAULT 0.00 COMMENT '积分费用(钻石费用)',
    ...
    `item_id`        bigint(0) NULL DEFAULT NULL,
    `create_time`    datetime(0) NULL DEFAULT CURRENT_TIMESTAMP (0),
    `update_time`    datetime(0) NULL DEFAULT CURRENT_TIMESTAMP (0) ON UPDATE CURRENT_TIMESTAMP (0) COMMENT '修改时间',
    `is_deleted`     tinyint(0) NULL DEFAULT 0,
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8  COMMENT = '订单表' ROW_FORMAT = Dynamic;
...
(
    ...
    `stock_number` bigint(0) NOT NULL COMMENT '库存编号',
